...
| --------------- | --------------- | ----------- |
| Hémisphère Nord | Horaire         | Antihoraire |
| Hémisphère Sud  | Antihoraire     | Horaire     |
...
Les systèmes de simulation du climat fonctionnent par la discrétisation et la résolution d'équation différentielles sur des modèles de la terre. Ainsi, on subdivise les continents, les océans et l'atmosphère en une maille, sur laquelle sera appliqué des contraintes physique déterminées empiriquement. On peut donc en tirer des prédictions. 